VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} usfSheets_old 
   Caption         =   "Sheet Choice"
   ClientHeight    =   585
   ClientLeft      =   645
   ClientTop       =   2325
   ClientWidth     =   4890
   OleObjectBlob   =   "usfSheets_002.frx":0000
   ShowModal       =   0   'False
End
Attribute VB_Name = "usfSheets_old"
...
'Display the important sheet
  Me.ComboBox1.ListIndex = 6
End Sub
