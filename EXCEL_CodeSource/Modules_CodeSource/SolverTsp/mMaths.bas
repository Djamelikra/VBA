...
Option Explicit
'mMaths
Function MeanOpt3Args5(arg1 As Single, arg2 As Single, Optional arg3 As Single, Optional arg4 As Single, Optional arg5 As Single) As Single
'     Application.Volatile 'switch
     
     If IsMissing(arg3) And IsMissing(arg4) And IsMissing(arg5) Then
        MeanOpt3Args5 = (arg1 + arg2) / 2
     
      ElseIf IsMissing(arg4) And IsMissing(arg5) Then
        MeanOpt3Args5 = (arg1 + arg2 + arg3) / 3
     
        ElseIf IsMissing(arg5) Then
        MeanOpt3Args5 = (arg1 + arg2 + arg3 + arg4) / 4
        
        Else
        MeanOpt3Args5 = (arg1 + arg2 + arg3 + arg4 + arg5) / 5
     End If
...
Sub Mean2to5()
    ...
    MsgBox MeanOpt3Args5(arg1, arg2, arg3, arg4, arg5), vbInformation, "Mean"
